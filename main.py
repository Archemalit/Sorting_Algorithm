...
class DrawInformation:
    ...
    def __init__(self, width, height, lst):
        ...
        pygame.display.set_caption('Sorting Algorithm Vizuallization')
        self.set_list(lst)
...
def draw(draw_info, algo_name, ascending):
    ...
    controls = draw_info.FONT.render('R - Reset | Space - Start Soring | A - Ascending | D - Descending', 1,
                                     draw_info.BLACK)
    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            if event.key == pygame.K_r:
                ...
                sorting = False
            if event.key == pygame.K_SPACE and sorting is False:
                sorting = True
